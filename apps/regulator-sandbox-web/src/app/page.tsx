/**
 * Fictional authority staff console.
 *
...
export default function Home() {
  return (
    <main style={{ maxWidth: '42rem', margin: '0 auto', padding: '4rem 1.5rem' }}>
      <h1 style={{ fontSize: '1.75rem', margin: '0 0 0.5rem' }}>Grievance & Ombudsman Sandbox</h1>
      <p style={{ color: 'var(--muted)', margin: '0 0 2rem' }}>Fictional authority staff console</p>
